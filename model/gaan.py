"""
Copied from https://github.com/dmlc/dgl/blob/master/examples/pytorch/dtgrnn/gaan.py
Author: Ericcsr
Paper: https://arxiv.org/pdf/1803.07294.pdf
"""
...
class GatedGAT(nn.Module):
    ...
    def __init__(self, in_feats, out_feats, map_feats, num_heads, **kwargs):
    ...
    def forward(self, g, x):
        ...
        Returns:
            merge: output embeddings, shape (num_nodes, out_dim)
        """
        with g.local_scope():
            g.ndata['x'] = x
